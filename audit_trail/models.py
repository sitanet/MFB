...
class AuditTrail(models.Model):
    ...
    # Branch tracking - audit trails are branch-specific
    branch_id = models.CharField(max_length=20, blank=True, null=True, db_index=True, help_text="Branch ID from vendor database")
