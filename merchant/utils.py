    ...
    try:
        with db_transaction.atomic():
            ...
            Memtrans.all_objects.create(
                ...
                description=f'NIN Verification Charge - {transaction_ref}',
                error='A',
                type='D',
                account_type='L',
                ses_date=session_date,
            ...
            Memtrans.all_objects.create(
                ...
                amount=api_cost,
                description=f'NIN API Cost - {merchant.merchant_name}',
                error='A',
                type='C',
                account_type='E',
                ses_date=session_date,
            ...
            if profit_amount > 0 and nin_config.profit_gl_no:
                Memtrans.all_objects.create(
                    ...
                    description=f'NIN Verification Income - {merchant.merchant_name}',
                    error='A',
                    type='C',
                    account_type='I',
                    ses_date=session_date,
